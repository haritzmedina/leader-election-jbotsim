...
public class Main {
    ...
    public static int defaultBoundStep = 5;
    ...
    public static void main(String[] args) {
        ...
        topologia.setDefaultNodeModel(NodeLeaderWithCommDelays.class);
        ...
        NodeLeaderWithCommDelays[] nodos= new NodeLeaderWithCommDelays[NumNodos];// Array que contendrá los nodos creados

        int [] coordenadas = new int[2];      // Array auxiliar para calcular las coordenadas de cada nodo

        for (int i = 0; i < NumNodos; i++) {
            nodos[i] = new NodeLeaderWithCommDelays();          // Creación del nodo
